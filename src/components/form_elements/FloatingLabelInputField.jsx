    ...
    <section>
      <div className="w-full relative">
        <input
          type="text"
          required
          className="w-[40vw] h-14 rounded-lg text-xl leading-[3.5rem] px-4 bg-transparent border-2 border-black focus:border-focus-500 !outline-0 peer"
        ...
        <label
          ...
          peer-valid:text-xs peer-valid:top-0 peer-valid:px-1 peer-valid:bg-white peer-valid:text-focus-500 peer-focus:text-focus-500"
